...
/**
*
* This script is used for Paypal
*
* @author Novalnet AG
...
class NovalnetPaypal implements AsynchronousPaymentHandlerInterface
{
    /**
    ...
    public function finalize(AsyncPaymentTransactionStruct $transaction, Request $request, SalesChannelContext $salesChannelContext): void
    {
        ...
        $note = $this->helper->prepareComments($novalnetResponse, 'novalnetpaypal', $salesChannelContext->getContext(), $paymentId);
        $this->helper->insertNovalnetTransactionDetails($novalnetResponse, $this->configDetails, 'novalnetpaypal');
        ...
        if (!empty($novalnetResponse['tid_status'])) {
            if (in_array($novalnetResponse['tid_status'], [100, 90, 85])) {
            ...
            } elseif (in_array($novalnetResponse['tid_status'], [85, 90])) {
