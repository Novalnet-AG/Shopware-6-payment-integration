...
/**
*
* This script is used for EPS Payment
*
* @author Novalnet AG
...
class NovalnetEps implements AsynchronousPaymentHandlerInterface
{
    /**
    ...
    public function finalize(AsyncPaymentTransactionStruct $transaction, Request $request, SalesChannelContext $salesChannelContext): void
    {
        ...
        $note = $this->helper->prepareComments($novalnetResponse, 'novalneteps', $salesChannelContext->getContext(), $paymentId);
        $this->helper->insertNovalnetTransactionDetails($novalnetResponse, $this->configDetails, 'novalneteps');
