...
class NovalnetIdeal implements AsynchronousPaymentHandlerInterface
{
    /**
    ...
    public function finalize(AsyncPaymentTransactionStruct $transaction, Request $request, SalesChannelContext $salesChannelContext): void
    {
        ...
        $note = $this->helper->prepareComments($novalnetResponse, 'novalnetideal', $salesChannelContext->getContext(), $paymentId);
        $this->helper->insertNovalnetTransactionDetails($novalnetResponse, $this->configDetails, 'novalnetideal');
