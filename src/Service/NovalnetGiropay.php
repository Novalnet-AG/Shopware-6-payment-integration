...
/**
*
* This script is used for GIROPAY Payment
*
* @author Novalnet AG
...
class NovalnetGiropay implements AsynchronousPaymentHandlerInterface
{
    /**
    ...
    public function finalize(AsyncPaymentTransactionStruct $transaction, Request $request, SalesChannelContext $salesChannelContext): void
    {
        ...
        $note = $this->helper->prepareComments($novalnetResponse, 'novalnetgiropay', $salesChannelContext->getContext(), $paymentId);
        $this->helper->insertNovalnetTransactionDetails($novalnetResponse, $this->configDetails, 'novalnetgiropay');
