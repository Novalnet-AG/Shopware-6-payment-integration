...
/**
*
* This script is used for Przelewy24
*
* @author Novalnet AG
...
class NovalnetPrzelewy24 implements AsynchronousPaymentHandlerInterface
{
    /**
    ...
    {
        $url='https://payport.novalnet.de/globalbank_transfer';
    ...
    public function finalize(AsyncPaymentTransactionStruct $transaction, Request $request, SalesChannelContext $salesChannelContext): void
    {
        ...
        $note = $this->helper->prepareComments($novalnetResponse, 'novalnetprzelewy24', $salesChannelContext->getContext(), $paymentId);
        $this->helper->insertNovalnetTransactionDetails($novalnetResponse, $this->configDetails, 'novalnetprzelewy24');
        ...
        if (!empty($novalnetResponse['tid_status'])) {
            if (in_array($novalnetResponse['tid_status'], [100, 86])) {
            ...
            } elseif ('86' === $novalnetResponse['tid_status']) {
